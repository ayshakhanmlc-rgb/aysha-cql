...
export const quests: Quest[] = [
  ...
  // Additional POI quests for more map life
  {
    ...
    whyYoullLove: ['See how tech works at scale', 'Meet real engineers and PMs', 'Creative problem-solving culture'],
    whatYoullDo: ['Tour the campus', 'Shadow a product design sprint', 'Q&A with engineers and designers'],
  },
  {
    id: 'conedison', title: 'Con Edison',
    subtitle: 'See how NYC\'s power grid actually works — from control rooms to street-level infrastructure',
    location: [40.7396, -73.9834], address: '4 Irving Place, Manhattan',
    vibe: 'fixer', xp: 180, reward: 'Grid Operator badge', matchPercent: 82,
    date: 'Sat, Mar 15', time: '10am - 1pm', transit: '4/5/6 to 14th St–Union Sq',
    partyRequired: false, locked: false, thumbnail: questTrading,
    whyYoullLove: ['See the systems that power 10 million people', 'Real-time operations you never knew existed', 'Engineering meets public service'],
    whatYoullDo: ['Tour a control center', 'Learn how the grid responds to emergencies', 'Meet engineers who keep NYC running'],
  },
  {
    id: 'northwell', title: 'Northwell Health',
    subtitle: 'Explore careers across NYC\'s largest healthcare system — from ER operations to health tech',
    location: [40.7628, -73.9510], address: '1981 Marcus Avenue, New Hyde Park (NYC offices in Midtown)',
    vibe: 'connector', xp: 175, reward: 'Health Innovator badge', matchPercent: 79,
    date: 'Sat, Mar 22', time: '9am - 12pm', transit: 'E/M to Lexington Ave–53rd St',
    partyRequired: false, locked: false, thumbnail: questSinai,
    whyYoullLove: ['NYC\'s biggest health system with 80K+ employees', 'Dozens of career paths beyond just doctors', 'Real impact on communities across all boroughs'],
    whatYoullDo: ['Shadow healthcare professionals', 'Tour a simulation training center', 'Explore health tech and innovation labs'],
  },
  {
    id: 'goldman', title: 'Goldman Sachs',
    subtitle: 'Step inside one of the world\'s most influential financial institutions and see what Wall Street is really about',
    location: [40.7145, -74.0135], address: '200 West Street, Manhattan',
    vibe: 'competitor', xp: 250, reward: 'Finance Leader badge', matchPercent: 76,
    date: 'Fri, Apr 4', time: '2pm - 5pm', transit: '1 train to Chambers St',
    partyRequired: false, locked: false, thumbnail: questTrading,
    whyYoullLove: ['See how global markets actually work', 'Meet analysts and traders from all backgrounds', 'Problem-solving at massive scale'],
    whatYoullDo: ['Tour the trading floor', 'Meet analysts from the firm\'s diversity programs', 'Attend a mock market simulation'],
  },
  {
    id: 'jpmorgan', title: 'JPMorgan Chase',
    subtitle: 'Discover careers in tech, finance, and community impact at one of the world\'s largest banks',
    location: [40.7558, -73.9753], address: '383 Madison Avenue, Manhattan',
    vibe: 'competitor', xp: 225, reward: 'Strategy Analyst badge', matchPercent: 74,
    date: 'Sat, Apr 12', time: '10am - 1pm', transit: '4/5/6 to Grand Central',
    partyRequired: false, locked: false, thumbnail: questTrading,
    whyYoullLove: ['Technology is at the heart of modern banking', 'Community investment programs across NYC', 'Career paths you didn\'t know existed in finance'],
    whatYoullDo: ['Tour tech innovation labs', 'Meet employees from community development programs', 'Workshop on financial literacy and career planning'],
  },
  {
    id: 'nycgov', title: 'City of New York',
    subtitle: 'See how city government actually works — from City Hall to the agencies shaping NYC\'s future',
    location: [40.7128, -74.0060], address: 'City Hall, Manhattan',
    vibe: 'connector', xp: 200, reward: 'Civic Leader badge', matchPercent: 85,
    date: 'Sat, Apr 19', time: '10am - 1pm', transit: '4/5/6 to Brooklyn Bridge–City Hall',
    partyRequired: false, locked: false, thumbnail: questSinai,
    whyYoullLove: ['See democracy in action at City Hall', 'NYC gov employs 300K+ people across every field', 'Shape the future of your own city'],
    whatYoullDo: ['Tour City Hall and the Council chambers', 'Meet young professionals in city agencies', 'Learn about pathways into public service'],
  },
  {
    id: 'moma', title: 'MoMA',
